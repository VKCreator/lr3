...
const app = new Vue({
    ...
    methods: {
        ...
        move() {
            ...
            if (document.getElementById("petrolButton").classList.contains("active") && (this.currentPetrol - this.weightImpulse * 20 / 1000) >= 0) 
            {
                ...
                this.currentPetrol -= (this.weightImpulse * 20 / 1000);
                this.currentSpeed = ((this.weightMachine + this.currentPetrol) * this.currentSpeed - this.weightImpulse * dt * this.speedExpiry * dt) / (this.weightMachine + this.currentPetrol - this.weightImpulse * dt);
            }
            else 
            {
    ...
    watch: {
        ...
        currentPetrol() {
            ...
            if ((this.currentPetrol - this.weightImpulse * 20 / 1000) < 0) {
